...
function email_list_page (&$page_data, $page_name, $options) {
    switch ($page_name) {
        ...
        case 'email_lists':
            ...
            if (user_access('email_list_view')) {
                $email_lists = theme('table', 'email_list', array('join'=>array('contact'), 'show_export'=>false, 'lists_only'=>true));
                if (user_access('email_list_edit')) {
        ...
        case 'email_list':
            ...
            if (user_access('email_list_edit')) {
                ...
                page_add_content_top($page_data, theme('table', 'email_list_subscribers', array('join'=>array('contact'), 'show_export'=>false, 'lists_only'=>false, 'lid'=>$lid)));
            }
            break;
    }
}
